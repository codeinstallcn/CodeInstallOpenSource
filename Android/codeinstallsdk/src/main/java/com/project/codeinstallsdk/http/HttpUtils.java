package com.project.codeinstallsdk.http;
            ...
            public void run() {
                ...
                try {
                    ...
                    if (responseCode == 200) {
                        ...
                        String result = inputStream2String(inputStream);
                        if (result != null && callback != null) {
                            //Log.e("dfdsfd", "postSuccessObject: "+result );
                            //Log.e("dfdsfd", "fromJson: "+new Gson().toJson(new Gson().fromJson(result, cls)) );
                    ...
                    //Log.e("inputStream2String", "run: "+e.toString() );
                    e.printStackTrace();
                    if (callback != null) {
                        postFailed(callback, 0, e);
                    }
